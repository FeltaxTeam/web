...
export default function Widget(props: { guild, owner?}) {
  ...
  const contentFilterLevel = {
    0: {
      name: 'Disabled',
      description: 'Don\'t scan any messages.',
    },
    1: {
      name: 'Medium',
      description: 'Scan messages sent by members without a role.',
    },
    2: {
      name: 'High',
      description: 'Scan messages sent by all members.',
    }
  }
  return (
    <React.Fragment>
      <div className='column-master'>
        <div className="embed stats-container">
          ...
          <div className="verificationLevel">
            <div className="title">VERIFICATION LEVEL</div>
            <div className={`container c${guild.explicit_content_filter}`}>
              <span>
                {verificationLevel[guild.verification_level].name}
              </span>
              <p>
                {verificationLevel[guild.verification_level].description}
              </p>
            </div>
          </div>
          <div className="explicitContentFilter">
            <div className="title">EXPLICIT CONTENT FILTER</div>
            <div className={`container c${guild.explicit_content_filter}`}>
              <span>
                {contentFilterLevel[guild.explicit_content_filter].name}
              </span>
              <p>
                {contentFilterLevel[guild.explicit_content_filter].description}
              </p>
            </div>
          </div>
        </div>
