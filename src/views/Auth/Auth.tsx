...
export default function Auth() {
	...
	if (!searchParams.has('access_token')) window.location.assign(`https://discord.com/api/oauth2/authorize?client_id=568435616153337916&redirect_uri=http%3A%2F%2F${window.location.host.replace(':', '%3A')}%2Fauth%2F&response_type=token&scope=guilds%20guilds.members.read%20email%20identify&prompt=none`);
	return (
		<>
			<AuthLogic />
		</>
